...
setup(
    ...
    description='Watches for changes in a directory tree, and runs a command when something changed',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/nthienan/watcher',
    author='An Nguyen',
    ...
    keywords='watcher, k8s, openshift, kubernetes',
    ...
    project_urls={
        'Bug Reports': 'https://github.com/nthienan/watcher/issues',
        'Source': 'https://github.com/nthienan/watcher',
    },
